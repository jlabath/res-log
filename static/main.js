...
var _jlabath$res_log$OrderedDict$forceUnwrap = function (maybe) {
	var _p0 = maybe;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'OrderedDict',
			{
				start: {line: 353, column: 3},
				end: {line: 355, column: 40}
			},
			_p0)('Impossible');
	}
};
var _jlabath$res_log$OrderedDict$unique = function (list) {
	var accum = F2(
		function (v, _p2) {
			var _p3 = _p2;
			var _p5 = _p3._0;
			var _p4 = _p3._1;
			return A2(_elm_lang$core$Set$member, v, _p5) ? {ctor: '_Tuple2', _0: _p5, _1: _p4} : {
				ctor: '_Tuple2',
				_0: A2(_elm_lang$core$Set$insert, v, _p5),
				_1: A2(
					_elm_lang$core$List$append,
					_p4,
					_elm_lang$core$Native_List.fromArray(
...
var _jlabath$res_log$OrderedDict$keys = function (dict) {
	return A2(
		_elm_lang$core$List$map,
		_elm_lang$core$Basics$fst,
		A2(
			...
			_elm_lang$core$Dict$toList(dict.items)));
};
var _jlabath$res_log$OrderedDict$size = function (dict) {
	return _elm_lang$core$Dict$size(dict.items);
};
var _jlabath$res_log$OrderedDict$get = F2(
	function (k, dict) {
		var _p6 = A2(_elm_lang$core$Dict$get, k, dict.items);
		if (_p6.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			var _p7 = A2(_elm_lang$core$Array$get, _p6._0, dict.indexes);
			if (_p7.ctor === 'Nothing') {
				return _elm_lang$core$Native_Utils.crashCase(
					'OrderedDict',
					{
...
var _jlabath$res_log$OrderedDict$values = function (dict) {
	return A2(
		_elm_lang$core$List$map,
		function (k) {
			return _jlabath$res_log$OrderedDict$forceUnwrap(
				A2(_jlabath$res_log$OrderedDict$get, k, dict));
		},
		_jlabath$res_log$OrderedDict$keys(dict));
};
var _jlabath$res_log$OrderedDict$toList = function (dict) {
	return A3(
		_elm_lang$core$List$map2,
		F2(
			function (v0, v1) {
		...
		_jlabath$res_log$OrderedDict$keys(dict),
		_jlabath$res_log$OrderedDict$values(dict));
};
var _jlabath$res_log$OrderedDict$foldl = F3(
	function (accum, init, dict) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (_p11, memo) {
					var _p12 = _p11;
					return A3(accum, _p12._0, _p12._1, memo);
				}),
			init,
			_jlabath$res_log$OrderedDict$toList(dict));
	});
var _jlabath$res_log$OrderedDict$foldr = F3(
	function (accum, init, dict) {
		return A3(
			_elm_lang$core$List$foldr,
			F2(
				function (_p13, memo) {
					var _p14 = _p13;
					return A3(accum, _p14._0, _p14._1, memo);
				}),
			init,
			_jlabath$res_log$OrderedDict$toList(dict));
	});
var _jlabath$res_log$OrderedDict$merge = F6(
	function (accumLeft, accumBoth, accumRight, left, right, init) {
		var accum = F2(
			function (k, result) {
				var _p15 = {
					ctor: '_Tuple2',
					_0: A2(_jlabath$res_log$OrderedDict$get, k, left),
					_1: A2(_jlabath$res_log$OrderedDict$get, k, right)
				};
				if (_p15._0.ctor === 'Just') {
					if (_p15._1.ctor === 'Nothing') {
						return A3(accumLeft, k, _p15._0._0, result);
					} else {
						return A4(accumBoth, k, _p15._0._0, _p15._1._0, result);
					}
				} else {
					if (_p15._1.ctor === 'Just') {
						return A3(accumRight, k, _p15._1._0, result);
					} else {
						return _elm_lang$core$Native_Utils.crashCase(
							'OrderedDict',
							{
								start: {line: 309, column: 7},
								end: {line: 313, column: 55}
							},
							_p15)('Impossible');
					}
				}
			});
		var allKeys = _jlabath$res_log$OrderedDict$unique(
			_elm_lang$core$List$concat(
				_elm_lang$core$Native_List.fromArray(
					[
						_jlabath$res_log$OrderedDict$keys(left),
						_jlabath$res_log$OrderedDict$keys(right)
					])));
		return A3(_elm_lang$core$List$foldl, accum, init, allKeys);
	});
var _jlabath$res_log$OrderedDict$member = F2(
	function (k, dict) {
		return A2(_elm_lang$core$Dict$member, k, dict.items);
	});
var _jlabath$res_log$OrderedDict$isEmpty = function (dict) {
	return _elm_lang$core$Dict$isEmpty(dict.items);
};
var _jlabath$res_log$OrderedDict$remove = F2(
	function (k, dict) {
		var _p17 = A2(_elm_lang$core$Dict$get, k, dict.items);
		if (_p17.ctor === 'Nothing') {
			...
			return _elm_lang$core$Native_Utils.update(
				dict,
				{
					items: A2(_elm_lang$core$Dict$remove, k, dict.items),
					indexes: A3(_elm_lang$core$Array$set, _p17._0, _elm_lang$core$Maybe$Nothing, dict.indexes)
				});
		}
	});
var _jlabath$res_log$OrderedDict$insert = F3(
	function (k, v, dict) {
		return A2(_elm_lang$core$Dict$member, k, dict.items) ? dict : _elm_lang$core$Native_Utils.update(
			dict,
			{
				items: A3(
					_elm_lang$core$Dict$insert,
					k,
					_elm_lang$core$Array$length(dict.indexes),
					dict.items),
				indexes: A2(
...
var _jlabath$res_log$OrderedDict$update = F3(
	function (k, xform, dict) {
		var _p18 = A2(_elm_lang$core$Dict$get, k, dict.items);
		if (_p18.ctor === 'Nothing') {
			var _p19 = xform(_elm_lang$core$Maybe$Nothing);
			if (_p19.ctor === 'Nothing') {
				return dict;
			} else {
				return A3(_jlabath$res_log$OrderedDict$insert, k, _p19._0, dict);
			}
		} else {
			var _p25 = _p18._0;
			var _p20 = A2(_elm_lang$core$Array$get, _p25, dict.indexes);
			if (_p20.ctor === 'Nothing') {
				return _elm_lang$core$Native_Utils.crashCase(
					'OrderedDict',
					{
						start: {line: 106, column: 7},
						end: {line: 124, column: 80}
					},
					_p20)('Impossible');
			} else {
				var _p22 = _p20._0;
				if (_p22.ctor === 'Nothing') {
					...
					if (_p24.ctor === 'Nothing') {
						return A2(_jlabath$res_log$OrderedDict$remove, k, dict);
					} else {
						return _elm_lang$core$Native_Utils.update(
							dict,
							{
...
var _jlabath$res_log$OrderedDict$union = F2(
	function (left, right) {
		return A3(_jlabath$res_log$OrderedDict$foldl, _jlabath$res_log$OrderedDict$insert, right, left);
	});
var _jlabath$res_log$OrderedDict$empty = {items: _elm_lang$core$Dict$empty, indexes: _elm_lang$core$Array$empty};
var _jlabath$res_log$OrderedDict$singleton = F2(
	function (k, v) {
		return A3(_jlabath$res_log$OrderedDict$insert, k, v, _jlabath$res_log$OrderedDict$empty);
	});
var _jlabath$res_log$OrderedDict$fromList = function (list) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (_p26, memo) {
				var _p27 = _p26;
				return A3(_jlabath$res_log$OrderedDict$insert, _p27._0, _p27._1, memo);
			}),
		_jlabath$res_log$OrderedDict$empty,
		list);
};
var _jlabath$res_log$OrderedDict$map = function (xform) {
	return function (_p28) {
		return _jlabath$res_log$OrderedDict$fromList(
			A2(
				_elm_lang$core$List$map,
				function (_p29) {
					var _p30 = _p29;
					...
					return {
						ctor: '_Tuple2',
						_0: _p31,
						_1: A2(xform, _p31, _p30._1)
					};
				},
				_jlabath$res_log$OrderedDict$toList(_p28)));
	};
};
var _jlabath$res_log$OrderedDict$filter = F2(
	function (pred, dict) {
		var accum = F3(
			function (k, v, memo) {
				return A2(pred, k, v) ? A3(_jlabath$res_log$OrderedDict$insert, k, v, memo) : memo;
			});
		return A3(_jlabath$res_log$OrderedDict$foldl, accum, _jlabath$res_log$OrderedDict$empty, dict);
	});
var _jlabath$res_log$OrderedDict$intersect = F2(
	function (left, right) {
		return A2(
			_jlabath$res_log$OrderedDict$filter,
			F2(
				function (k, v) {
					return A2(_jlabath$res_log$OrderedDict$member, k, right);
				}),
			left);
	});
var _jlabath$res_log$OrderedDict$diff = F2(
	function (left, right) {
		return A2(
			_jlabath$res_log$OrderedDict$filter,
			F2(
				function (k, v) {
					return _elm_lang$core$Basics$not(
						A2(_jlabath$res_log$OrderedDict$member, k, right));
				}),
			left);
	});
var _jlabath$res_log$OrderedDict$partition = F2(
	function (pred, dict) {
		var accum = F3(
			function (k, v, _p32) {
				var _p33 = _p32;
				...
				return A2(pred, k, v) ? {
					ctor: '_Tuple2',
					_0: A3(_jlabath$res_log$OrderedDict$insert, k, v, _p35),
					_1: _p34
				} : {
					ctor: '_Tuple2',
					_0: _p35,
					_1: A3(_jlabath$res_log$OrderedDict$insert, k, v, _p34)
				};
			});
		return A3(
			_jlabath$res_log$OrderedDict$foldl,
			accum,
			{ctor: '_Tuple2', _0: _jlabath$res_log$OrderedDict$empty, _1: _jlabath$res_log$OrderedDict$empty},
			dict);
	});
var _jlabath$res_log$OrderedDict$compact = function (dict) {
	return A3(_jlabath$res_log$OrderedDict$foldl, _jlabath$res_log$OrderedDict$insert, _jlabath$res_log$OrderedDict$empty, dict);
};
var _jlabath$res_log$OrderedDict$OrderedDictRecord = F2(
	function (a, b) {
		return {items: a, indexes: b};
	});

var _jlabath$res_log$Generic$dictDecoder = function (decoder) {
	return A2(
		_elm_lang$core$Json_Decode$map,
		_jlabath$res_log$OrderedDict$fromList,
		_elm_lang$core$Json_Decode$keyValuePairs(decoder));
};
var _jlabath$res_log$Generic$toJson = function (value) {
	var _p0 = value;
	switch (_p0.ctor) {
		case 'Num':
		...
		case 'Lst':
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _jlabath$res_log$Generic$toJson, _p0._0));
		case 'Dct':
			var convert = function (_p1) {
				var _p2 = _p1;
				return {
					ctor: '_Tuple2',
					_0: _p2._0,
					_1: _jlabath$res_log$Generic$toJson(_p2._1)
				};
			};
			var pairs = A2(
				_elm_lang$core$List$map,
				...
				_elm_lang$core$List$reverse(
					_jlabath$res_log$OrderedDict$toList(_p0._0)));
			return _elm_lang$core$Json_Encode$object(pairs);
		default:
			return _elm_lang$core$Json_Encode$null;
	}
};
var _jlabath$res_log$Generic$Nil = {ctor: 'Nil'};
var _jlabath$res_log$Generic$nilDecoder = _elm_lang$core$Json_Decode$null(_jlabath$res_log$Generic$Nil);
var _jlabath$res_log$Generic$Dct = function (a) {
	return {ctor: 'Dct', _0: a};
};
var _jlabath$res_log$Generic$Lst = function (a) {
	return {ctor: 'Lst', _0: a};
};
var _jlabath$res_log$Generic$Bln = function (a) {
	return {ctor: 'Bln', _0: a};
};
var _jlabath$res_log$Generic$blnDecoder = A2(_elm_lang$core$Json_Decode$map, _jlabath$res_log$Generic$Bln, _elm_lang$core$Json_Decode$bool);
var _jlabath$res_log$Generic$Txt = function (a) {
	return {ctor: 'Txt', _0: a};
};
var _jlabath$res_log$Generic$txtDecoder = A2(_elm_lang$core$Json_Decode$map, _jlabath$res_log$Generic$Txt, _elm_lang$core$Json_Decode$string);
var _jlabath$res_log$Generic$Num = function (a) {
	return {ctor: 'Num', _0: a};
};
var _jlabath$res_log$Generic$numDecoder = A2(_elm_lang$core$Json_Decode$map, _jlabath$res_log$Generic$Num, _elm_lang$core$Json_Decode$float);
var _jlabath$res_log$Generic$buildDecoder = function (_p3) {
	return _elm_lang$core$Json_Decode$oneOf(
		_elm_lang$core$Native_List.fromArray(
			[
				_jlabath$res_log$Generic$numDecoder,
				_jlabath$res_log$Generic$blnDecoder,
				_jlabath$res_log$Generic$txtDecoder,
				_jlabath$res_log$Generic$nilDecoder,
				_jlabath$res_log$Generic$buildLstDecoder(
				{ctor: '_Tuple0'}),
				_jlabath$res_log$Generic$buildDctDecoder(
				{ctor: '_Tuple0'})
			]));
};
var _jlabath$res_log$Generic$buildDctDecoder = function (_p4) {
	return A2(
		...
		function (_p5) {
			return A2(
				_elm_lang$core$Json_Decode$map,
				_jlabath$res_log$Generic$Dct,
				_jlabath$res_log$Generic$dictDecoder(
					_jlabath$res_log$Generic$buildDecoder(_p5)));
		});
};
var _jlabath$res_log$Generic$buildLstDecoder = function (_p6) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		_elm_lang$core$Json_Decode$succeed(
			{ctor: '_Tuple0'}),
		function (_p7) {
			return A2(
				_elm_lang$core$Json_Decode$map,
				_jlabath$res_log$Generic$Lst,
				_elm_lang$core$Json_Decode$list(
					_jlabath$res_log$Generic$buildDecoder(_p7)));
		});
};
var _jlabath$res_log$Generic$decoder = _jlabath$res_log$Generic$buildDecoder(
	{ctor: '_Tuple0'});
var _jlabath$res_log$Generic$fromJson = function (blob) {
	return A2(_elm_lang$core$Json_Decode$decodeValue, _jlabath$res_log$Generic$decoder, blob);
};
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								text(
								A2(_elm_lang$core$Basics_ops['++'], 'SHA1: ', model.sha1))
							])),
						A2(
						li,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								text(
								A2(_elm_lang$core$Basics_ops['++'], 'Fetch Date: ', model.fetchdate))
							])),
						A2(
						li,
						_elm_lang$core$Native_List.fromArray(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								text(
								A2(_elm_lang$core$Basics_ops['++'], 'Hook Date: ', model.hookdate))
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
...
var _jlabath$res_log$Entry$Model = F4(
	function (a, b, c, d) {
		return {fetchdate: a, hookdate: b, resource: c, sha1: d};
	});
var _jlabath$res_log$Entry$decode = A3(
	...
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'resource',
		_jlabath$res_log$Generic$decoder,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'hookdate',
			_elm_lang$core$Json_Decode$string,
...
var _jlabath$res_log$HistoryView$add = F2(
	function (m, log) {
		...
		return _elm_lang$core$Native_Utils.update(
			log,
			{
				records: A2(_elm_lang$core$List_ops['::'], m, newrecords)
			});
	});
var _jlabath$res_log$HistoryView$Model = F3(
	function (a, b, c) {
		return {resId: a, resType: b, resTypeLabel: c};
	});
var _jlabath$res_log$HistoryView$Log = function (a) {
	return {records: a};
};
var _jlabath$res_log$HistoryView$empty = _jlabath$res_log$HistoryView$Log(
	_elm_lang$core$Native_List.fromArray(
		[]));
var _jlabath$res_log$HistoryView$Clicked = function (a) {
	return {ctor: 'Clicked', _0: a};
};
var _jlabath$res_log$HistoryView$renderModel = function (m) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				'click',
				_elm_lang$core$Json_Decode$succeed(
					_jlabath$res_log$HistoryView$Clicked(m)))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					m.resTypeLabel,
					A2(_elm_lang$core$Basics_ops['++'], ' ', m.resId)))
			]));
};
var _jlabath$res_log$HistoryView$view = function (log) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _jlabath$res_log$HistoryView$renderModel, log.records))
			]));
};

var _jlabath$res_log$Main$lstGet = F2(
	function (index, list) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, index, list));
	});
var _jlabath$res_log$Main$toSelectTuples = F2(
	function (acc, xs) {
		toSelectTuples:
		while (true) {
			var _p0 = xs;
			if (_p0.ctor === '[]') {
				...
				acc = _v1;
				xs = _v2;
				continue toSelectTuples;
			}
		}
	});
var _jlabath$res_log$Main$decodeData = _elm_lang$core$Json_Decode$list(_jlabath$res_log$Entry$decode);
...
var _jlabath$res_log$Main$onKeyPress = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keypress',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$keyCode));
};
var _jlabath$res_log$Main$onChange = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$targetValue));
};
var _jlabath$res_log$Main$updateNoOp = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _jlabath$res_log$Main$init = function (initType) {
	return {
		ctor: '_Tuple2',
		_0: {
			...
			entries: _elm_lang$core$Native_List.fromArray(
				[]),
			error: '',
			currentModel: _elm_lang$core$Maybe$Nothing,
			status: '',
			log: _jlabath$res_log$HistoryView$empty
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _jlabath$res_log$Main$Model = F7(
...
var _jlabath$res_log$Main$KeyPress = function (a) {
	return {ctor: 'KeyPress', _0: a};
};
var _jlabath$res_log$Main$FetchSucceeded = function (a) {
	return {ctor: 'FetchSucceeded', _0: a};
};
var _jlabath$res_log$Main$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _jlabath$res_log$Main$getData = F2(
	function (resType, resId) {
		var url = A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				resType,
				A2(_elm_lang$core$Basics_ops['++'], '/', resId)));
		return A3(
			_elm_lang$core$Task$perform,
			_jlabath$res_log$Main$FetchFail,
			_jlabath$res_log$Main$FetchSucceeded,
			A2(_evancz$elm_http$Http$get, _jlabath$res_log$Main$decodeData, url));
	});
...
var _jlabath$res_log$Main$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'GetAction':
				return _jlabath$res_log$Main$updateGetAction(model);
			case 'ChangeType':
				var newmodel = _elm_lang$core$Native_Utils.update(
					model,
					{resourceType: _p4._0});
			...
			case 'ChangeVersion':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentModel: A2(_jlabath$res_log$Main$lstGet, idx, model.entries)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyPress':
...
var _jlabath$res_log$Main$ChangeType = function (a) {
	return {ctor: 'ChangeType', _0: a};
};
var _jlabath$res_log$Main$GetAction = {ctor: 'GetAction'};
var _jlabath$res_log$Main$Entry = function (a) {
...
var _jlabath$res_log$Main$view = function (model) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$id('resapp')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('resform')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$for('restype')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$for('resid')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$id('resid'),
								_elm_lang$html$Html_Attributes$value(model.resourceId),
								_jlabath$res_log$Main$onKeyPress(_jlabath$res_log$Main$KeyPress),
								_elm_lang$html$Html_Events$onInput(_jlabath$res_log$Main$Entry)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$value('Get'),
								_elm_lang$html$Html_Events$onClick(_jlabath$res_log$Main$GetAction)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$for('reslst')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('resview')
					]),
				resview),
				A2(
				_elm_lang$html$Html_App$map,
				_jlabath$res_log$Main$HistoryMsg,
				_jlabath$res_log$HistoryView$view(model.log))
			]));
};
var _jlabath$res_log$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _jlabath$res_log$Main$init(
				_elm_lang$core$Basics$fst(
					A2(
						_elm_lang$core$Maybe$withDefault,
						{ctor: '_Tuple2', _0: 'departures', _1: ''},
						_elm_lang$core$List$head(_jlabath$res_log$Main$resourceList)))),
			view: _jlabath$res_log$Main$view,
			update: _jlabath$res_log$Main$update,
			subscriptions: _jlabath$res_log$Main$subscriptions
		})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _jlabath$res_log$Main$main === 'undefined' ? null : _jlabath$res_log$Main$main);
